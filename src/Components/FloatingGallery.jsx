...
import Hover from "../assets/Hover2.mp3";
  ...
  return (
    ...
    >
      ...
      <div className="GALLERY-CONTAINER    w-[100%] h-[80%] relative flex items-center justify-center ">
        <div className="absolute left-1/2 translate-x-[-50%] top-0 w-fit h-fit  flex flex-col items-center justify-center space-y-[1vh]">
          <h1 className="text-white/90   uppercase font-heading2 text-5xl tracking-widest">
            Floating{" "}
          </h1>
          <h1 className="text-white/90   uppercase font-heading2 text-2xl tracking-widest">
            Pixels{" "}
          </h1>
        </div>
        <div
        ...
        >
          ...
          />
          <div
            className={`w-full py-2 px-5 space-y-3  text-white  ${
              opened && imageText == 1
